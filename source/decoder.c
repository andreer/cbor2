...
{
    // Heap allocate buffer, use fp_read directly (skip intermediate bytes object)
    ...
    PyObject *ret = PyUnicode_DecodeUTF8(buf, length, PyBytes_AS_STRING(self->str_errors));
    PyMem_Free(buf);
